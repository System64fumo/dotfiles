...
# Software/Themes i use
Distro: [ARMtix linux](https://armtixlinux.org/images)<br>
Compositor: [Hyprland](https://github.com/hyprwm/Hyprland)<br>
Terminal: [Foot](https://codeberg.org/dnkl/foot)<br>
Shell: [Sysshell](https://github.com/System64fumo/sysshell)<br>
Theme: [Colloid](https://github.com/vinceliuice/Colloid-gtk-theme)<br>
Icons: [Colloid](https://github.com/vinceliuice/Colloid-icon-theme)<br>
